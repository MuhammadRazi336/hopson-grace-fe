    ...
    <div className="xl:mx-20 py-[100px] mx-6">
        <div className="container mx-auto bg-[#446184]  py-16">
          ...
          <div className="container mx-auto">
            ...
            {/* Feedback Alert - Fixed to viewport, always visible at bottom-right */}
            {showAlert && (
              <div 
                className={`success-alert-popup fixed bottom-4 right-4 ${alertType === 'success' ? 'bg-green-500' : 'bg-red-500'} text-white px-6 py-3 rounded-lg shadow-lg z-[9999] animate-fade-in-out`}
                style={{ 
                  position: 'fixed', 
                  bottom: '1rem',
                  right: '1rem',
