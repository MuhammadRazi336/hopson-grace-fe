        ...
        <div className="flex flex-wrap xl:flex-nowrap justify-center xl:items-end items-center -mb-10 xl:-translate-y-[200px] ">
          ...
          <div className="xl:w-4/12 w-full">
            <div className="relative">
              ...
              />
              <div
                className="absolute top-[85%] -translate-x-[-35%] w-full h-full "
...
export function CoupleProfileViewHeader({onCartClick}) {
  return (
    <div className="container mx-auto flex justify-between md:items-start items-center md:pt-6 pt-2 fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm">
      <img
