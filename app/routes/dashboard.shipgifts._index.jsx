    ...
    <div className="pt-[4.323vw]">
      <div className=" p-4">
        <h2 className="mt-0 ivyora lg:text-[2.5vw] xl:text-[2.5vw] 2xl:text-[2.5vw] text-[24px] prata text-center lg:leading-[3.333vw] xl:leading-[3.333vw] 2xl:leading-[3.333vw] font-normal mb-1">
          <span className="prata">ready to </span>
          <span className="italic">FULFILL & SHIP?</span>
        </h2>
        <img
        ...
        <p className="max-w-[45.26vw] mx-auto text-center mt-[4.01vw] mb-6 lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] font-normal leading-relaxed lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] max-[1024px]:max-w-[90%]">
          Your registry gifts and funds will be ready when you are. Many couples
          choose to finalize selections and arrange deliveries after the
          wedding, giving them the greatest flexibility and a clearer sense of
          what they’ll truly need for their home.
        </p>
        <p className="max-w-[45.26vw] mx-auto text-center mt-4 mb-6 lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] font-normal leading-relaxed lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] max-[1024px]:max-w-[90%]">
          When you're ready, simply choose one of the options below to continue.
          ...
          <div className="bg-[#446184] lg:h-[92.813vw] xl:h-[92.813vw] 2xl:h-[92.813vw] xl:-left-8 lg:-left-8 2xl:-left-8  left-0 py-[4.688vw] relative flex items-center justify-center flex-col lg:w-[50%] w-full max-[768px]:p-10">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] lg:w-[33.021vw] xl:w-[33.021vw] 2xl:w-[33.021vw] mt-4 mb-4 text-center text-white">
                ...
                you review and make any final adjustments, then coordinate
                delivery. Simply let us know you're ready and we’ll be in touch
                to guide you through the final steps. Enjoy two complimentary
                shipments of your gifts; standard shipping rates apply to any
                extra deliveries.
              </p>
              <div>
                <button
            ...
            <div className="mt-[6.25vw] flex flex-col items-center justify-center">
              ...
              <p className="text-sm lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] lg:w-[33.021vw] xl:w-[33.021vw] 2xl:w-[33.021vw] mt-4 mb-4 text-center text-white">
                ...
                to receive the full amount. When you’re ready, let us know and
                we’ll securely arrange your transfer. Two withdrawals are on us;
                additional transfers incur a small processing fee.
              </p>
              <div>
                <button
            ...
            <div className="mt-[6.25vw] flex flex-col items-center justify-center">
              ...
              <p className="text-sm lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] lg:w-[33.021vw] xl:w-[33.021vw] 2xl:w-[33.021vw] mt-4 mb-4 text-center text-white">
                ...
                Travel to start designing your journey.
              </p>
              <div>
                <button
      ...
      <div className="container  mx-auto flex flex-col items-center justify-center">
        ...
        <p className="text-sm lg:text-[1.25vw] xl:text-[1.25vw] 2xl:text-[1.25vw] lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] max-w-[38.49vw] mt-4 mb-4 text-center max-[1024px]:hidden">
        ...
        <div>
          <Link
            to="https://calendly.com/concierge-theregistry/30min"
            target="_blank"
          >
      ...
      {showActionPopup && (
        <ShipGiftsActionPopup onClose={handleCloseActionPopup} />
      )}
