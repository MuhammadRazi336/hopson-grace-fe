...
const OurPhilosophy = () => {
  return (
    <>
      ...
      <section className='relative h-[27.083vw] max-[1024px]:h-[300px]'>
        ...
        <div className="absolute top-[50%] -translate-y-1/2 right-0 px-[11.094vw] max-[1024px]:px-[20px] max-[1024px]:pb-[20px] max-[1024px]:left-[50%] max-[1024px]:translate-x-[-50%]">
            ...
            <Heading
              text="our philosophy"
              classes={
                'prata text-black text-4xl lg:text-[2.5vw] xl:text-[2.5vw] 2xl:text-[2.5vw] lg:leading-[1.875vw] xl:leading-[1.875vw] 2xl:leading-[1.875vw] font-normal text-left mb-[1.719vw] max-[1024px]:text-[28px] max-[1024px]:mb-[15px]'
              }
