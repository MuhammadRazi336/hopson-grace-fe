...
const OnboardingClient = () => {
  ...
  const handleRegisterPost2 = async () => {
    const signupPayload = {
  ...
  async function goNext() {
    if (step === 1) {
      console.log("SADJoasda");
      setStep(step + 1);
    } else if (step === 2) {
      console.log(step, "SDpasda");
      setStep(step + 1);
    } else if (step === 3) {
      handleRegisterPost2();
    }
  ...
  const renderStepContent = (currentStep) => {
    switch (currentStep) {
      case 1:
        return (<Step1 formData={formDataRef} handleInputChange={handleInputChange} />);
      case 2:
        return (<Step2 setSelectedDate={setSelectedDate} selectedDate={selectedDate} />);
      case 3:
        return (<Step3 eventData={eventTypes}
...
const Step3 = ({
                 ...
                 selectedOption, handleSelectChange, eventData
               }) => {
  return (
    <div>
      <div className="text-center">
        <Heading text={"Do You Have Other Events where guest may buy gifts?"} />
        <h2 className="text-l font-bold mb-4">{"(ie. bridal shower , engagement party)"}</h2>
      </div>
      <div>
        <CustomSelect
          title={"Event Type"}
  ...
  return (
    <div>
      <div className="text-center">
        ...
        <h2 className="text-l font-bold mb-4">{"(Lorem ipsum dolor sit amit.)"}</h2>
      </div>
      {/* Event Name Input */}
      <Input
...
const Step5 = () => {
  // Initialize a single state to hold all form data
  const formDataRef = useRef({
    phoneNumber: "",
    address: "",
    postalCode: "",
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md">
      <div className="text-center">
        ...
        <h2
          className="text-l font-bold mb-4">{"You can update your address at any time or you can skip this step and add this later!"}</h2>
      </div>
...
const Step8 = () => {
  ...
  const options = [
    ...
    { id: 4, label: "Modern Farmhouse", imgSrc: "https://via.placeholder.com/150" },
    { id: 5, label: "Boho Chic", imgSrc: "https://via.placeholder.com/150" },
    { id: 6, label: "Mid-Century Modern", imgSrc: "https://via.placeholder.com/150" }
  ];
