        ...
        <div className="flex flex-col lg:flex-row gap-10 pt-[100px] px-[200px]">
          ...
          <div>
            ...
            <p className="text-xl lg:text-2xl">
              ...
              fee. You can withdraw your cash at any time or wait until after
              your wedding to receive the full amount. All you need is a
              Canadian or U.S. bank account and address.
            </p>
          </div>
        </div>
