...
const NewArrivals = () => {
  ...
  // Reset products to show when newArrivalsProducts change
  useEffect(() => {
  ...
  const displayedProducts = newArrivalsProducts.slice(0, productsToShow);
  const hasMoreProducts = newArrivalsProducts.length > productsToShow;
        ...
        <section className="w-[81.25vw] mx-auto py-12" ref={productGridRef}>
          ...
          <div className="flex flex-col items-center mt-12 space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              LOADING {displayedProducts.length} of {newArrivalsProducts.length} PRODUCTS
            </p>
