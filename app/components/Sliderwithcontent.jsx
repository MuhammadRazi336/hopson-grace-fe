  ...
  return (
    <div>
      <Heading
        ...
        classes={`text-[1.25vw] leading-[1.458vw] max-[1024px]:text-[14px] max-[1024px]:leading-[28px] font-bold uppercase tracking-[0.1em] mt-0 mb-[2.604vw]`}
      />
      ...
      <div className="tabandslider relative">
        ...
        <div className="max-[1024px]:hidden swiper-button-next-tab absolute right-[-80px] top-1/2.5 transform -translate-y-full z-10 cursor-pointer text-black uppercase flex">
          ...
          <img src={nextitem} alt="" className="rotate-270 lg:w-[1.042vw] lg:h-[1.042vw] xl:w-[1.042vw] xl:h-[1.042vw] 2xl:w-[1.042vw] 2xl:h-[1.042vw]" />
        </div>
      </div>
    </div>
  );
