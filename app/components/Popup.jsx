...
const Popup = ({ onClose }) => {
    return ( 
    <div className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center justify-center bg-[#1F1D1BE5] max-[768px]:flex-col max-[768px]:px-4 max-[768px]:items-end">
        <div className="relative left-[96px] max-[768px]:left-[initial]">
            <img src={popupimg} alt="" className="max-[768px]:max-w-[80%]" />
            <img src={imageFPO} alt="" className="absolute left-6 bottom-0" />
        </div>
        <div className="w-[618px] bg-[#446184] p-16 relative flex items-center justify-center text-white pb-[127px] -left-[96px] max-[768px]:left-[initial] max-[768px]:w-[80%] max-[768px]:-top-[60px] max-[768px]:p-8">
            ...
            <div className="mt-[116px] flex flex-col items-center justify-center max-[768px]:mt-12 ">
                ...
                <p className="text-6xl prata mb-16 text-center max-[768px]:text-2xl max-[768px]:mb-8">let's build your dream registry.</p>
                <Link onClick={onClose} to="/register" className="py-[15px] lg:py-[30px] bg-white text-center text-black uppercase text-lg w-[225px] lg:w-[320px] font-medium">LET'S GO</Link>
            </div>
        </div>
    </div>
     );
