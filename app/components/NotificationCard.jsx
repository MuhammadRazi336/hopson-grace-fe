...
const NotificationCard = ({
  ...
  const handleViewClick = (e) => {
    ...
    if (typeof window !== 'undefined') {
      window.dispatchEvent(new CustomEvent(OPEN_NOTIFICATION_DROPDOWN_EVENT));
    }
  };

  return (
    <div
      className={`bg-[#f5f2ed] rounded-sm p-6 lg:p-[1.51vw] xl:p-[1.51vw] 2xl:p-[1.51vw] w-64 lg:-w-[13.542vw] xl:-w-[13.542vw] 2xl:-w-[13.542vw] text-center relative shadow-sm max-[1024px]:w-full max-[1024px]:p-[20px] ${className}`}
    >
