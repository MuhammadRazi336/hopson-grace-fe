  ...
  return (
    <div className="relative items-start mt-10 lg:mt-[3.958vw] xl:mt-[3.958vw] 2xl:mt-[3.958vw] lg:mb-0 mb-10 max-[1024px]:my-[30px]">
      <div className="max-[1024px]:max-w-[78%] w-[81.25vw] mx-auto relative">
        <div className="swiper-button-prev-prod absolute top-0 max-[1024px]:left-[-38px] left-[-9.6vw] h-[160px] cursor-pointer text-white uppercase flex w-[139px] items-center bg-[#446184] lg:w-[7.24vw] lg:h-[18.75vw] justify-center max-[1024px]:w-[28px]">
          ...
          {products.map((product) => {
            ...
            return (
              <SwiperSlide key={productNode.id}>
                <div 
                  className="cursor-pointer w-[18.75vw] max-[767px]:w-full"
        ...
        <div className="swiper-button-next-prod absolute top-0 max-[1024px]:right-[-38px] right-[-9.6vw] cursor-pointer text-white uppercase flex lg:w-[7.24vw] lg:h-[18.75vw] h-[160px] items-center bg-[#446184] justify-center max-[1024px]:w-[28px]">
