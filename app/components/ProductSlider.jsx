  ...
  return (
    <div className="relative items-start mt-10 lg:mt-[3.958vw] xl:mt-[3.958vw] 2xl:mt-[3.958vw] lg:mb-0 mb-10 max-[1024px]:my-[30px]">
      <div className="max-[1024px]:max-w-[78%] mx-auto">
        <div className="swiper-button-prev-prod absolute top-0 max-[1024px]:left-0 left-[-82px] h-[160px] cursor-pointer text-white uppercase flex w-[139px] items-center bg-[#446184] lg:w-[7.24vw] lg:h-[18.75vw] justify-center max-[1024px]:w-[28px]">
        ...
        <div className="swiper-button-next-prod absolute top-0 max-[1024px]:right-0 right-[-82px] cursor-pointer text-white uppercase flex lg:w-[7.24vw] lg:h-[18.75vw] h-[160px] items-center bg-[#446184] justify-center max-[1024px]:w-[28px]">
