...
const TopHeader = () => {
    ...
    return ( 
        <div className="bg-[#1F1D1B] h-[3.333vw] max-[1024px]:h-[36px] max-[1024px]:py-[5px] max-[1024px]:px-[0px] max-[1024px]:mb-0 mb-[2.813vw] flex items-center justify-center text-white py-[15px] text-center text-sm min[767px]:text-[20px] tracking-[3.6px]">
            <div className="container text-[1.042vw] max-[1024px]:text-[9px] max-[1024px]:leading-[36px]">
                {isLoggedIn ? (
                    <>
                        <Link to="/products" className="text-white px-1 lg:tracking-[3.6px] tracking-[0] font-bold hover:text-gray-300 transition-colors">
                            EXPLORE PRODUCTS <span className="lg:text-[0.833vw] ml-[8px] text-[14px] max-[1024px]:text-[8px] max-[1024px]:ml-[5px]">▶</span>
                        </Link>
                        ...
                        <Link to="/our-brands" className="text-white px-1 lg:tracking-[3.6px] tracking-[0] font-bold hover:text-gray-300 transition-colors">
                            SHOP BY BRAND <span className="lg:text-[0.833vw] ml-[8px] text-[14px] max-[1024px]:text-[8px] max-[1024px]:ml-[5px]">▶</span>
                        </Link>
                    </>
                ) : (
                    <>
