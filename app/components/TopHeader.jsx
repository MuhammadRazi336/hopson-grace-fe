        ...
        <div className="bg-[#1F1D1B] h-[3.333vw] max-[1024px]:h-[36px] max-[1024px]:py-[5px] max-[1024px]:px-[0px] max-[1024px]:mb-0 mb-[2.813vw] flex items-center justify-center text-white py-[15px] text-center text-sm min[767px]:text-[20px] tracking-[3.6px]">
            <div className="px-[2.083vw] text-[1.042vw] max-[1024px]:text-[9px] max-[1024px]:leading-[36px] w-full flex items-center">
                <div className="w-[20%] max-[1024px]:w-[15%] max-[1024px]:hidden">
                    <a href="https://www.hopsongrace.com/" target="_blank"><img src={TopLogo} alt="logo" className="w-[10.052vw] h-[0.781vw]" /></a>
                </div>
                <div className="w-[60%] max-[1024px]:w-[100%] flex items-center justify-center text-[1.042vw] leading-[1.875vw] max-[1024px]:text-[9px] max-[1024px]:leading-[14px]">
                    {isLoggedIn ? (
                        <>
                            ...
                            <Link to="/dashboard/addgifts" className="text-white px-1 lg:tracking-[3.6px] tracking-[0] font-bold">
                                ADD GIFTS <span className="lg:text-[0.833vw] ml-[8px] text-[14px] max-[1024px]:text-[8px] max-[1024px]:ml-[5px]">▶</span>
                            </Link>
                        </>
                    ) : (
                        <>
                            ...
                            <Link onClick={handleOpenPopup} className="text-white px-1 lg:tracking-[3.6px] tracking-[0] font-bold">
                                START YOUR JOURNEY <span className="lg:text-[0.833vw] ml-[8px] text-[14px] max-[1024px]:text-[8px] max-[1024px]:ml-[5px]">▶</span>
                            </Link>
                        </>
                    )}
                </div>
