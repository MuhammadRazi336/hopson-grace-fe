    ...
    <div className='bg-[#1F1D1B] pt-[30px] pb-[30px] lg:pt-[90px] lg:pb-[60px] text-white'>
      <div className='px-8 lg:px-0 lg:max-w-[90%] mx-auto'>
          ...
          <div className='footer-logo'>
              <img src={footerImg} alt="Footer Icon" className="w-[260px] lg:w-[380px]" />
          </div>
          ...
          <div className="mt-8 lg:mt-[90px]">
              <div className="grid grid-cols-1 2xl:grid-cols-4 lg:grid-cols-2 gap-0 lg:gap-8">
                <div>
                  ...
                  <nav className={`transition-all duration-300 ${openNavIndex === 0 ? 'block' : 'hidden'} lg:block`}>
                ...
                <div>
                  <h4  className='text-[14px] lg:text-lg font-[800] uppercase mt-[15px] mb-[15px] lg:mb-[30px] lg:mt-[8px] text-white tracking-[0.08em] flex justify-between lg:justify-start items-start' 
                    onClick={() => toggleNav(1)}>Customer Care <img src={dropdown} alt="" className='lg:hidden' /></h4>
                  <nav className={`transition-all duration-300 ${openNavIndex === 1 ? 'block' : 'hidden'} lg:block`}>
                    <ul className="text-white text-[16px] font-[500] leading-[36px] tracking-[0.08em]">
                ...
                <div>
                  <h4  className='text-[14px] lg:text-lg font-[800] uppercase mt-[15px] mb-[15px] lg:mb-[30px] lg:mt-[8px] text-white tracking-[0.08em] flex justify-between lg:justify-start items-start' 
                    onClick={() => toggleNav(2)}>Your Registry <img src={dropdown} alt="" className='lg:hidden' /></h4>
                  <nav className={`transition-all duration-300 ${openNavIndex === 2 ? 'block' : 'hidden'} lg:block`}>
                    <ul className="text-white text-[16px] font-[500] leading-[36px] tracking-[0.08em]">
                ...
                <div>
                  <h4  className='text-[14px] lg:text-lg font-[800] uppercase mt-[15px] mb-[15px] lg:mb-[30px] lg:mt-[8px] text-white tracking-[0.08em] flex justify-between lg:justify-start items-start' 
                    onClick={() => toggleNav(3)}>For Wedding Guests <img src={dropdown} alt="" className='lg:hidden' /></h4>
                  <nav className={`transition-all duration-300 ${openNavIndex === 3 ? 'block' : 'hidden'} lg:block`}>
                    <ul className="text-white text-[16px] font-[500] leading-[36px] tracking-[0.08em]">
          ...
          <div className="mt-0 lg:mt-[90px]">
              <div className="grid grid-cols-1 2xl:grid-cols-4 lg:grid-cols-2 gap-8">
                <div>
                  <h4  className='text-[14px] lg:text-lg font-[800] uppercase mt-[15px] mb-[15px] lg:mb-[30px] lg:mt-[8px] text-white tracking-[0.08em] flex justify-between lg:justify-start items-start' 
                    onClick={() => toggleNav(4)}>Contact Us <img src={dropdown} alt="" className='lg:hidden' /></h4>
                  <nav className={`transition-all duration-300 ${openNavIndex === 4 ? 'block' : 'hidden'} lg:block`}>
                    <ul className="text-white text-[16px] font-[500] leading-[36px] tracking-[0.08em]">
                ...
                <div>
                  <h4 className='text-[14px] lg:text-lg font-[800] uppercase mb-[30px] text-white tracking-[0.08em] hidden lg:block'>Follow Us</h4>
                  <nav>
                ...
                <div>
                  <h4 className='text-[14px] lg:text-lg font-[800] uppercase mb-[30px] text-white tracking-[0.08em] hidden lg:block'>Refer a Friend</h4>
                ...
                <div>
                  <h4 className='text-[14px] lg:text-lg font-[800] uppercase mb-[30px] text-white tracking-[0.08em]'>Stay in the Loop with Weekly Inspo</h4>
                  <nav>
                    <ul className="text-white text-[16px] font-[500] leading-[36px] tracking-[0.08em]">
                      <li>
                        <div className="flex">
                          <input type="email" aria-label="Email address" placeholder="hello@theregistry.com" className="px-4 py-2 md:w-[250px] bg-[#F5F2ED] m-0 border-0 text-[#948E8A] rounded-none font-['bastardogrotesk'] font-[400] text-[17px] leading-[24px] tracking-[0.03em] w-full" />
                          <button aria-label="Sign up for newsletter" className="py-3 bg-[#446184] text-[14px] font-bold uppercase rounded-none tracking-[0.08em] text-white w-[140px]">Sign Up</button>
                        </div>
                      </li>
                    </ul>
                  </nav>
