...
const StepsAndImage = ({ content, title, stepNo, totalSteps }) => {
    return ( 
        <div className="flex py-32 max-[768px]:py-10 justify-center max-[768px]:flex-col max-[768px]:items-center max-[768px]:px-4">
            ...
            <div className="bg-steel-blue text-white p-[110px] pb-28 pt-[100px] relative -left-[37.5px] top-[59px] max-[768px]:max-w-[100%] lg:max-w-[1000px] max-[1024px]:p-6 max-[768px]:-top-[140px] max-[768px]:left-2.5 max-[768px]:pb-20 max-[768px]:pt-14  max-[768px]:w-full text-center">
