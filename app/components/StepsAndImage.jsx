...
const StepsAndImage = ({ content, title, stepNo, totalSteps, className, showLoginLink = true, showPagination = true, onBackClick, showBackButton = false }) => {
    ...
    return ( 
        <div className={`flex py-32 max-[1024px]:py-10 justify-center max-[1024px]:w-full max-[1024px]:flex-col max-[1024px]:items-center max-[1024px]:px-4`}>
            ...
            <div className={`${className} bg-steel-blue text-white lg:py-[5.417vw] xl:py-[5.417vw] 2xl:py-[5.417vw] lg:px-[5.417vw] xl:px-[5.417vw] 2xl:px-[5.417vw] lg:w-[52.083vw] xl:w-[52.083vw] 2xl:w-[52.083vw] relative -left-[37.5px] top-[59px] lg:top-[3.073vw] xl:top-[3.073vw] 2xl:top-[3.073vw] max-[1024px]:max-w-[100%] max-w-[1000px] max-[1024px]:-top-[10.292vw] max-[1024px]:left-2.5 max-[1024px]:w-[95%] max-[1024px]:px-[24px] max-[1024px]:py-[27px] text-center`}>
