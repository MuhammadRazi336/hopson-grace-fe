...
const Textandbutton = () => {
  return (
    <div className="max-w-[1258px] mx-auto px-3">
      <h2 className=" lg:text-4xl xl:text-5xl 2xl:text-[56px] text-[28px] prata text-center lg:leading-[60px] font-normal mb-5">
        Your wedding <span className="italic ivyora font-normal">shouldn't be</span>{' '}
        ordinary, <br /> <span className="italic ivyora font-normal">nor should</span> your
        registry.
      </h2>
