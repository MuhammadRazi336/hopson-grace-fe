    ...
    try {
      ...
      response.headers.set(
        ...
        [
          ...
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://cdn.shopify.com https://embed.tawk.to https://*.tawk.to https://cdn.tawk.to https://*.cdn.tawk.to https://fonts.googleapis.com https://fonts.gstatic.com https://*.jsdelivr.net https://*.unpkg.com https://assets.calendly.com https://*.calendly.com https://static.klaviyo.com https://*.klaviyo.com",
          ...
          "frame-src 'self' https://www.youtube.com https://cdn.shopify.com https://*.shopify.com https://js.stripe.com https://www.google.com https://maps.google.com https://www.google.com/maps https://*.tawk.to https://*.jsdelivr.net https://*.unpkg.com https://*.calendly.com https://*.klaviyo.com",
          "child-src 'self' https://*.tawk.to https://*.jsdelivr.net https://*.unpkg.com https://*.calendly.com https://*.klaviyo.com",
          "connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://cdn.shopify.com https://monorail-edge.shopifysvc.com https://dev-hopsongrace.codup.io/api/forms/upload https://dev-hopsongrace.codup.io wss://dev-hopsongrace.codup.io https://www.google.com/ https://*.tawk.to wss://*.tawk.to https://*.jsdelivr.net https://*.unpkg.com https://*.calendly.com https://*.klaviyo.com",
