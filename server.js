    ...
    try {
      ...
      response.headers.set(
        ...
        [
          ...
          "connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://cdn.shopify.com https://monorail-edge.shopifysvc.com https://dev-hopsongrace.codup.io/api/forms/upload https://dev-hopsongrace.codup.io wss://dev-hopsongrace.codup.io https://api.paypal.com https://api.sandbox.paypal.com https://www.paypal.com https://www.google.com/ https://*.tawk.to wss://*.tawk.to https://*.jsdelivr.net https://*.unpkg.com https://*.calendly.com https://*.klaviyo.com",
